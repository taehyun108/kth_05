...
| **최신 기사일** | 피드의 가장 최근 `pubDate` | 오늘~며칠 이내 | **몇 주 전이면 갱신이 멈춘 피드다.** 200 이 오고 항목도 가득해서 건수로는 안 잡힌다. 실제로 전자신문 `06064.xml`(소재)이 2026-09-01 시점 **68일 정체** 상태였다. 섹션 폐지·이전 여부를 확인하고 대체 피드로 교체 |
